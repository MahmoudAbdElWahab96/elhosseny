                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    {{ Form::model($sales_channel, ['route' => ['biller.markets.update', $sales_channel], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-additional']) }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="edit-form-btn">
                                            ...
                                            {{ Form::hidden('id', $sales_channel->id) }}

...
<div class="">
    <div class="content-wrapper">
        ...
        <div class="content-body">
            {{ Form::open(['route' => ['biller.business.update_settings',['id' => $company->id]], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post','files' => true, 'id' => 'manage-company']) }}
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="card rounded">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p class="mb-2"><br><img class="img-fluid" src="{{Storage::disk('public')->url('app/public/img/company/ico/' . @$company['icon'])}}" alt="Business favicon"></p>
                                ...
                                <!-- <hr>
                                    ...
                                    <p class="mb-2"><br><img class="img-fluid avatar-100" src="{{Storage::disk('public')->url('app/public/img/company/theme/' . @$company['theme_logo'])}}" alt="Business header logo"></p>
                                    ...
                                    <p class="mb-2"><br><img class="img-fluid avatar-lg" src="{{Storage::disk('public')->url('app/public/img/company/' . @$company['logo'])}}" alt="Business Logo"></p>

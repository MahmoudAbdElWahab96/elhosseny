                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                                    ...
                                    <div id="customerpanel" class="inner-cmp-pnl">
                                        ...
                                        <div id="customer">
                                            ...
                                            <div class="clientinfo">
                                                <div id="customer_address1">{{$invoices->customer->address}}
                                                    , {{$invoices->customer->city}}</div>
                                            </div>
                                            <div class="clientinfo">
                                    ...
                                    <div class="inner-cmp-pnl">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6"><label for="invocieno"
                                                                         class="caption">{{trans('invoices.tid')}}
                                                    #{{$sub['prefix']}}</label>
                                ...
                                <table class="table-responsive tfr my_stripe">
                                    ...
                                    <tr class="sub_c" style="display: table-row;">
                                        ...
                                        <td align="left" colspan="2"><span
                                            ...
                                            <span id="discs"
                                                  class="lightMode">{{numberFormat($invoices['discount']-$invoices['extra_discount'])}}</span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="sub_c" style="display: table-row;">
                                        ...
                                        <td align="left" colspan="2"><input type="text" class="form-control shipVal"
                                                                            ...
                                                                            onkeyup="billUpyog()"
                                                                            value="{{numberFormat($invoices['shipping'])}}">
                                            ( {{trans('general.tax')}} {{config('currency.symbol')}}
                                            <span id="ship_final">{{numberFormat($invoices['ship_tax'])}}</span> )
                                        </td>
                                    </tr>
                                    <tr class="sub_c" style="display: table-row;">
                                    ...
                                    <tr class="sub_c" style="display: table-row;">
                                        ...
                                        <td align="left" colspan="2"><input type="text" name="total"
                                                                            class="form-control"
                                                                            value="{{numberFormat($invoices['total'])}}"
                            ...
                            <input type="hidden" value="{{route('biller.invoices.update',$invoices['id'])}}"
                                   id="action-url">
                            ...
                            <input type='hidden' value='{{numberFormat($invoices['ship_tax_rate'])}}'
                            ...
                            <input type="hidden" value="{{numberFormat($invoices['ship_tax'])}}" name="ship_tax"
                                   id="ship_tax">

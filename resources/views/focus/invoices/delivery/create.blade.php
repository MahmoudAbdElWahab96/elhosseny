                    ...
                    <div class="receipt_panel" id="receipt_section">
                        ...
                        <div class="pay_section">
                            <div id="bt_section" class="form-group text-center">
                                ...
                                <a  href="{{route('biller.invoices.index',["md"=>"sub"])}}" class="view_invoice_config btn btn-info font-medium-5 " title="Settings">
                                    List
                                </a>
                                <a href="{{route('biller.invoices.index')}}" class="customer_mobile_view btn btn-info font-medium-5" title="Settings">
                                    List
                                </a>
                            </div>
                        </div>
        ...
        @section('extra-scripts')
            <script type="text/javascript">
              ...
              array_push($pmt, "Change");
                ...
                function printInKitchen(invoiceId)
                {
                    $.ajaxSetup({
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')

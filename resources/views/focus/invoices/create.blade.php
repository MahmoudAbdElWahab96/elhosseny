                                            ...
                                            @if( $orderedSupply_show && $orderedSupply_show->is_require == 1)
                                                <div class="form-group row">
                                                    <div class="frmSearch col-sm-12">
                                                        {{ Form::label( 'ordered_supply_id', trans('orderedSupply.management'),['class' => 'caption']) }}
                                                        <select
                                                                id="orderedSupply"
                                                                name="ordered_supply_id"
                                                                class="form-control round mt-1">
                                                            <option value="0">{{trans('general.all')}}</option>
                                                            @foreach($orderedSupplys as $key => $orderedSupply)
                                                                <option value="{{$orderedSupply}}" >{{$orderedSupply}}</option>
                                                            @endforeach
                                                        </select>
...
{{--                                                                data-type3="off">{{trans('general.off')}}</option>--}}
                                ...
                                <input type="hidden" value="{{$tax_format_type}}" name="tax_format"
                                       id="tax_format_type">
                                <input type="hidden" value="{{$tax_format_id}}" name="taxs_id" id="tax_format_id">

                                ...
                                <div class="card-body">
                                    <table id="openingBalance-table"
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ trans('accounts.debit') }}</th>
                                            <th>{{ trans('accounts.credit') }}</th>
...
@section('after-scripts')
    ...
    <script>
        ...
        function draw_data() {
            ...
            var dataTable = $('#openingBalance-table').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ajax: {
                    url: '{{ route("biller.opening_balance.get") }}',
                    type: 'post'
                },
                columns: [

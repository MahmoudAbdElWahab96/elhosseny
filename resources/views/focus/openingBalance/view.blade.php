                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col border-blue-grey border-lighten-5  p-1 font-weight-bold">
                                            <p>   {{$opening['number']}} <a class="btn btn-purple round"
                                                                            href="{{route('biller.opening_balance.index')}}?rel_type=9&rel_id={{$opening['id']}}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col border-blue-grey border-lighten-5  p-1 font-weight-bold">
                                            <p>   {{amountFormat($opening['balance'])}}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col border-blue-grey border-lighten-5  p-1 font-weight-bold">
                                            <p>   {{optional($opening->where('id', $opening['account_type'])->first())->holder}}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">

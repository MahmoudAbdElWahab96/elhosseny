...
@section ('title', trans('labels.backend.costcenters.management'))

@section('page-header')
    <h1>{{ trans('labels.backend.costcenters.management') }}</h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">{{ trans('labels.backend.costcenters.management') }}</h4>
    ...
    <script>
        $(function () {
            ...
            var dataTable = $('#costcenters-table').dataTable({
                ...
                ajax: {
                    url: '{{ route("biller.costcenters.get") }}',
                    type: 'post'
                },
                columns: [

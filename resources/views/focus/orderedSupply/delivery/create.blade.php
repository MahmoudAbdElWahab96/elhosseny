...
@section('content')
    <form id="data_form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6"><label for="invociedate"
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::text('orderedSupplydate', null, ['class' => 'form-control round required', 'placeholder' => trans('orderedSupply.orderedSupply_date'),'data-toggle'=>'datepicker','autocomplete'=>'false']) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6"><label for="invocieduedate"
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::text('orderedSupplyduedate', null, ['class' => 'form-control round required', 'placeholder' => trans('orderedSupply.orderedSupply_due_date'),'data-toggle'=>'datepicker','autocomplete'=>'false']) }}
                                    </div>
                                </div>
                    ...
                    <div class="receipt_panel" id="receipt_section">
                        ...
                        <div class="pay_section">
                            <div id="bt_section" class="form-group text-center">
                                ...
                                <a  href="{{route('biller.orderedSupply.index',["md"=>"sub"])}}" class="view_orderedSupply_config btn btn-info font-medium-5 " title="Settings">
                                    List
                                </a>
                                <a href="{{route('biller.orderedSupply.index')}}" class="customer_mobile_view btn btn-info font-medium-5" title="Settings">
                                    List
                                </a>
                            </div>
                        </div>
        ...
        <input type="hidden" value="{{route('biller.orderedSupply.pos_store')}}" id="pos_action">
        ...
        @section('extra-scripts')
            <script type="text/javascript">
                ...
                $("#pos_payment").on("show.bs.modal", function (e) {
                    $('.p_amount').val($('#orderedSupplyyoghtml').val());
                    update_pay_pos();
                });
              ...
              array_push($pmt, "Change");
                ...
                function printInKitchen(orderedSupplyId)
                {
                    $.ajaxSetup({
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    ...
                    $.ajax({
                        url: '{{route('biller.pos.browser_kitchen_print')}}',
                        dataType: "html",
                        method: 'get',
                        data: 'id=' + orderedSupplyId,
                        success: function (data) {
                            $('#print_section').html(data);
                            $('#pos_print').modal('toggle');
                            $("#print_section").printThis({
                ...
                function print(orderedSupplyId)
                {
                    $.ajaxSetup({
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')

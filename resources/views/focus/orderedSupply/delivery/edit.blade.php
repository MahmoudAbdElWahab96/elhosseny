...
@section('content')
    ...
    <div class="pos_panel">
        <div class="rose_wrapper" id="sales_box">
            <div class="rose_wrap_left">
                ...
                <div id="orderedSupply_config">
                    <div class="row m-0">
                        <div class="col-10">
                            <fieldset class="form-group position-relative has-icon-left">
                                <input type="text" class="form-control "
                                       placeholder="{{trans('orderedSupply.search_client')}}" id="customer-box"
                                       name="cst">
                                <div class="form-control-position">
                        ...
                        <div class="row">
                            <div class="col-sm-6"><label for="invocieno"
                                ...
                                <div class="input-group">
                                    ...
                                    {{ Form::number('tid', null, ['class' => 'form-control round', 'placeholder' => trans('orderedSupply.tid')]) }}
                                </div>
                            </div>
                            <div class="col-sm-6"><label for="invocieno"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6"><label for="invociedate"
                                ...
                                <div class="input-group">
                                    ...
                                    {{ Form::text('orderedSupplydate', date_for_database($orderedSupply['orderedSupplydate']), ['class' => 'form-control round required', 'placeholder' => trans('orderedSupply.orderedSupply_date'),'data-toggle'=>'datepicker','autocomplete'=>'false','id'=>'date1']) }}
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6"><label for="invocieduedate"
                                ...
                                <div class="input-group">
                                    ...
                                    {{ Form::text('orderedSupplyduedate', date_for_database($orderedSupply['orderedSupplyduedate']), ['class' => 'form-control round required', 'placeholder' => trans('orderedSupply.orderedSupply_due_date'),'data-toggle'=>'datepicker','autocomplete'=>'false','id'=>'date2']) }}
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="form-control round"
                                    ...
                                    @foreach($additionals as $additional_tax)
                                        ...
                                        @php
                                            if($additional_tax->id == $orderedSupply['tax_id']  && $additional_tax->class == 1 && $tax_flag){
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control round"
                                        ...
                                        @foreach($additionals as $additional_discount)
                                            @php
                                                if($additional_discount->type1== $orderedSupply['discount_format'] && $additional_discount->class == 2){
                ...
                <div class="receipt_panel" id="receipt_section">
                        ...
                        <div>
                            <div class="p-1 text-bold-600">
                                ...
                                <div class="float-right">
                                    <a class="view_orderedSupply_config badge badge-primary white "
                            ...
                            <div class="info_tab display-block">
                                ...
                                <i id="pos_customer">{{$orderedSupply->customer->name}}</i>
                    ...
                    <div class="bottom-section font-medium-3">
                        <div class="money">
                            ...
                            <div class="summary-margin">{{trans('general.total_discount')}}: <span>{{config('currency.symbol')}}   <span
                                            id="discs"
                                            class="lightMode">{{numberFormat($orderedSupply['discount']-$orderedSupply['extra_discount'])}}</span></span>
                            </div>
                            <div class="summary-margin">{{trans('general.total')}}: <span>{{config('currency.symbol')}} <span
                                            id="bigtotal" class="lightMode">{{numberFormat($orderedSupply['total'])}}</span></span>
                            </div>
                    ...
                    <div class="pay_section">
                        <div id="bt_section" class="form-group text-center">
                            ...
                            <a
                                    href="#" class="view_orderedSupply_config btn btn-info font-medium-5 "
                                    title="Settings"><i
    ...
    <input type="hidden" value="{{route('biller.orderedSupply.draft_store')}}" id="pos_action_draft">
    ...
    <input type='hidden'
           value='{{numberFormat($orderedSupply['ship_tax_rate'])}}'
           name='ship_rate' id='ship_rate'><input
            type='hidden' value='{{$orderedSupply['ship_tax_type']}}' name='ship_tax_type'
            id='ship_taxtype'>

    <input type="hidden" value="{{numberFormat($orderedSupply['ship_tax'])}}" name="ship_tax" id="ship_tax">
    <input type="hidden" value="0" id="custom_discount">
    <input type="hidden" name="total" class="form-control"
           id="orderedSupplyyoghtml" readonly="" value="{{numberFormat($orderedSupply['total'])}}">
    <input type="hidden" value="{{$orderedSupply['id']}}" name="id">
    <input type="hidden" value="{{numberFormat($orderedSupply['pamnt'])}}" name="paid_amount" id="paid_amount">
...
@section('extra-scripts')
  ...
  $(document).on('change', '#s_warehouses', function (e) {
        ...
        $("#pos_payment").on("show.bs.modal", function (e) {
            ...
            var ttl_pos = accounting.unformat($('#orderedSupplyyoghtml').val(), accounting.settings.number.decimal);

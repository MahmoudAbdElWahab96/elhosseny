...
@section ('title', trans('labels.backend.discounts.management'))

@section('page-header')
    <h1>{{ trans('labels.backend.discounts.management') }}</h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="">{{ trans('labels.backend.discounts.management') }}</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    <div class="alert alert-info"> {{trans('business.manage_default_discount')}}<a
...
@section('after-scripts')
    ...
    <script>
        $(function () {
            ...
            var dataTable = $('#discounts-table').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                language: {
                ...
                ajax: {
                    url: '{{ route("biller.discounts.get") }}',
                    type: 'post'
                },
                columns: [
            ...
            $('#discounts-table_wrapper').removeClass('form-inline');

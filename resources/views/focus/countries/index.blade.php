        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">{{ trans('labels.backend.countries.management') }}</h4>
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    <table id="countries-table"
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th>{{ trans('countries.Desc_en') }}</th>
                                            <th>{{ trans('countries.Desc_ar') }}</th>
    ...
    <script>
        $(function () {
            ...
            var dataTable = $('#countries-table').dataTable({
                ...
                ajax: {
                    url: '{{ route("biller.countries.get") }}',
                    type: 'post'
                },
                columns: [
            ...
            $('#countries-table_wrapper').removeClass('form-inline');

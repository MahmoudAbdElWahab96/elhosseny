                                                    ...
                                                    <div class='form-group'>
                                                        ...
                                                        <div class='col-lg-10'>
                                                            <select class="form-control" name="shift" id="shift">
                                                                <option value="1" @if(@$hrms->meta['shift']== 1) selected @endif>{{trans('general.shifts.1')}}</option>
                                                                <option value="2" @if(@$hrms->meta['shift']== 2) selected @endif>{{trans('general.shifts.2')}}</option>
                                                                <option value="3" @if(@$hrms->meta['shift']==  3) selected @endif>{{trans('general.shifts.3')}}</option>
                                                            </select>
                                                        </div>
                                                    </div>
{{--                                                    <div class="row">--}}

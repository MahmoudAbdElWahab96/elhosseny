    ...
    <div class='form-group'>
        {{ Form::label( 'name_en', trans('productvariables.name_en'),['class' => 'col-lg-2 control-label']) }}
        <div class='col-lg-3'>
            {{ Form::text('name_en', null, ['class' => 'form-control round', 'placeholder' => trans('productvariables.name_en')]) }}
        </div>
    </div>
    <div class='form-group'>

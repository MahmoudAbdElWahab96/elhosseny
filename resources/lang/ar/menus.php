...
return [
  'backend' => [
    ...
    'orderedSupply' => [
        'all' => 'جميع امور التوريد',
        'create' => 'إنشاء امر توريد',
        'edit' => 'تحرير امر توريد',
        'management' => 'إدارة امر توريد',
        'main' => 'امر توريد',
    ],
    'additionals' => [
    ...
    'transactioncategories' => [
      'all' => 'جميع فئات الحركات',
      'create' => 'إنشاء فئة الحركات',
      'edit' => 'تحرير فئة الحركة',
      'management' => 'إدارة فئة الحركات',
      'main' => 'فئات الحركات',
    ],
    'productvariables' => [
      ...
      'management' => 'إدارة متغيرات المنتج',
      'main' => 'متغيرات المنتج',
    ],
    'hrms' => [

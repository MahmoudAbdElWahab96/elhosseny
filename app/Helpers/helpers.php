...
//    $additionals = \App\Models\additional\Additional::all();
    $additionals = \App\Models\tax\Tax::all();
    ...
    return compact('customer_name','customer_phone','customer_email','warehouses', 'additionals', 'currencies', 'terms', 'customergroups', 'fields', 'defaults');
}
...
function product_helper()
{
    ...
    $product_code = SettingsRequiredFields::where('model_type', Product::class)->where('field', 'code')->select(['is_require'])->first();

...
class InvoiceRepository extends BaseRepository
{
    ...
    public function getForDataTable()
    {
        ...
        return
            $q->get(['id', 'tid', 'order_id', 'customer_id', 'invoicedate', 'invoiceduedate', 'total', 'status']);
    }
    ...
    public function create(array $input)
    {
        ...
        $input['invoice']['ordered_supply_id'] = @$input['invoice']['ordered_supply_id'];
        $input['invoice']['sub_tax_id'] = @$input['invoice']['sub_tax_id'];

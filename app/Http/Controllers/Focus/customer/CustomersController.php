...
class CustomersController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        ->orWhere('phone', 'LIKE', '%' . $q . '%')->limit(6)->get(array('id', 'name', 'phone', 'address', 'city', 'email', 'company'));

 ...
 */
class CostCentersAllTableController extends Controller
{
    /**
    ...
    {
        $core = $this->resource->getForCostCentersDataTable();
        return Datatables::of($core)
            ...
            ->addColumn('screen_type', function ($resource) {
                return optional($resource->screens)->name_ar;
            })

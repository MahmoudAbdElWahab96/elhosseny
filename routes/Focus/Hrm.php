...
Route::group( ['namespace' => 'hrm'], function () {
    ...
    //ahmed elbaz
    Route::get('hrms/attendance-view', 'HrmsController@attendanceView')->name('hrms.attendanceView');
    Route::post('hrms/attendance-actions-store', 'HrmsController@attendanceActionsStore')->name('hrms.attendanceActionsStore');
    Route::get('hrms/get-user-by-code', 'HrmsController@getUserByCode')->name('hrms.getUserByCode');
    //
    Route::get('hrms/payroll', 'HrmsController@payroll')->name('hrms.payroll');
    ...
    Route::get('hrms/roles/create', 'HrmsController@getHrmsRoles')->name('hrms.get.roles');
    Route::post('hrms/roles', 'HrmsController@storeHrmsRoles')->name('hrms.store.roles');

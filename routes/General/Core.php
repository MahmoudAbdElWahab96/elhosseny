...
Route::group(['namespace' => '\App\Http\Controllers\Focus', 'as' => 'biller.'], function () {
  ...
  Route::group(['namespace' => 'communication'], function () {
    ...
    Route::group(['namespace' => 'communication', 'middleware' => 'valid_token'], function () {
        ...
        Route::get('print_bill_kitchen/{id}/{type}/{token}/{pdf}', 'BillsController@print_kitchen_pdf')->name('print_bill_kitchen');
    ...
    Route::group(['namespace' => 'general', 'middleware' => 'biller'], function () {
        ...
        Route::get('general/settings', 'SettingsController@all_settings')->name('settings.all');
        Route::post('general/settings/product','SettingsController@store_product_fields')->name('settings.product');
        Route::post('general/settings/customer','SettingsController@store_customer_fields')->name('settings.customer');
        Route::post('general/settings/orderedSupply','SettingsController@store_orderedSupply_fields')->name('settings.orderedSupply');
        Route::post('general/settings/account','SettingsController@store_account_fields')->name('settings.account');
